    ...
    <main>
        <section id="contenidos">
                    ...
                    ?>
                        ...
                        <form id="formObtComp" autocomplete="off" method="post" action="experienciaNoAcademica.php">
                                ...
                                <div class="col s12 l6 input-field">
                                      ...
                                      <input type="text" id="organizacion" name="organizacion" data-validetta="required,number,minLength[8],maxLength[10]">
                                </div>
                                <div class="col s12 16 input-field">
                ...
                <form id="formObtComp" autocomplete="off" method="post" action="experienciaNoAcademica.php">
                               <div class="col s12 16 input-field">
                                ...
                                <div class="col s12 l6 input-field">
                                     <i class="fa fa-tools fa prefix"></i>
                                     <label for="actPuObt">Actividad o Puesto:</label>
                                     <input type="text" id="actividad" value='<?=$a?>' name="actividad" data-validetta="required,number,minLength[8],maxLength[10]">
                                ...
                                <div class="col s12 l6 input-field">
                                      <i class="fa fa-building fa prefix"></i>
                                      <label for="OrgObt">Organizaci&oacute;n o empresa:</label>
                                      <input type="text" value='<?=$b?>' id="organizacion" name="organizacion" data-validetta="required,number,minLength[8],maxLength[10]">
                                </div>
                                <div class="col s12 16 input-field">
                                ...
                                <div class="col s12 l6 input-field">
                                      <i class="fas fa-calendar-plus prefix"></i>
                                      <label for="anioIni">A&ntilde;o de inicio: </label>
                                      <input type="text" id="anioInicio" value='<?=$c?>' name="anioInicio" data-validetta="required,number,Length[4]">
                                </div> 
                                ...
                                <div class="col s12 l6 input-field">
                                      <i class="fas fa-calendar-times prefix"></i>
                                      <label for="anioFin">A&ntilde;o de t&eacute;rmino: </label>
                                      <input type="text" id="anioFin" value='<?=$e?>' name="anioFin" data-validetta="required,number,minLength[8],maxLength[10]">
                                </div> 
          ...
          ?>
                ...
                <a href='?v=1'>Agregar Experiencia Profesional No Acad&eacute;mica</a> <br>
                <?=$tabla?>
          <?php
              }
            }
