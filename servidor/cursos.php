<?php
	...
	if($_SESSION["activada"]=="v")
	{
		...
		$j =  isset($_REQUEST["j"]) ? $objeto->decodificaURL($_REQUEST["j"]) : "";//horasTotales
                        ...
                        <form id="formObtComp" autocomplete="off" method="post" action="cursos.php">
                                ...
                                <div class="col s12 l6 input-field">
								  ...
								  <div class="col s12 l6 input-field">
                                        ...
                                        <input type="text"  required class="datepicker" id="curso" name="curso" data-validetta="required,number,minLength[8],maxLength[10]">
                                  </div>
								  
								  
								  <div class="col s12 l6 input-field">
                                        <label for="horas">Horas invertidas:</label>
                                        <input type="number"  required class="datepicker" id="horas" name="horas" data-validetta="required,number,minLength[4],maxLength[4]">
                                  </div>
                                ...
                                <div class="col s12 8 input-field ">
									<a href="./index.html" class="btn red" style="width:100%;">CANCELAR</a>
                                </div>
					...
					?>
						...
						<form id="formObtComp" autocomplete="off" method="post" action="cursos.php">
                                ...
                                <div class="col s12 l6 input-field">
								  ...
								  <div class="col s12 l6 input-field">
                                        <label for="curso">Nombre curso:</label>
                                        <input type="text" value='<?=$o?>' required class="datepicker" id="curso" name="curso" data-validetta="required,number,minLength[8],maxLength[10]">
                                  </div>
								  
								  
								  <div class="col s12 l6 input-field">
                                        <label for="horas">Horas invertidas:</label>
                                        <input type="number" value='<?=$j?>' required class="datepicker" id="horas" name="horas" data-validetta="required,number,minLength[4],maxLength[4]">
                                  </div>
