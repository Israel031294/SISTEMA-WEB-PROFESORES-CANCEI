...
<body>
    <header>
      <section id="encabezado">
            <div class="container">
                    <h2 class="blue-grey-text center-align">Actualizaci&oacute;n Disciplinar</h2>
                    <hr>
                        ...
                        <form id="formObtComp" autocomplete="off" method = "POST" action = "actualizacionDis.php">
                                <div class="col s12 l6 input-field">
									 ...
									 <select name = "tipo" id = "tipo" value="<?=$t?>" placeholder= "Tipo" data-validetta="required,number,minLength[8],maxLength[10]" required>
										...
										<option value = "Crecimiento Integral">Crecimiento Integral</option>
                                ...
                                <div class="col s12 8 input-field ">
										...
										<a href="?tl=1">Ver Actualizaciones</a>
										<?php
										}
										?>
                                </div>
