<?php
		...
		if($oculto!=""){
			$objeto = new Persona();
			$respuesta=$objeto->registrarDatos(1,$nombre, $paterno, $materno, $email ,$tel, $pass ,$diaN , $mesN,$anioN,$puestoP,$idInst);
                        ...
                        <form id="formObtComp" autocomplete="off" method="post" action="crearCuenta.php">
                                ...
                                <div class="col s12 l6 input-field">
								  ...
								  <div class="col s12 l6 input-field">
                                        ...
                                        <input type="text"   id="anioNac" name="anioNac" data-validetta="required,number,minLength[4],maxLength[4]">
                                  </div>
                                  ...
                                  <div class="col s12 l6 input-field">
                                        ...
                                        <input type="email"  required id="correo" name="correo" data-validetta="required,email">
                                  </div>

                                  <div class="col s12 l6 input-field">
                                        <i class="fa fa-phone fa prefix"></i>
                                        <label for="telObt">Tel/Cel:</label>
                                        <input type="number"  required id="tel" name="tel" data-validetta="required,number,minLength[8],maxLength[10]">
                                  </div>

                                  <div class="col s12 l6 input-field">
                                        <i class="fa fa-key fa prefix"></i>
                                        <label for="contasenaObt">Contrase&ntilde;a:</label>
                                        <input type="text"  required id="contrasena" name="contrasena" data-validetta="required">
                                  </div>
