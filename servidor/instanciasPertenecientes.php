                ...
                <div class="row">
					...
					?>
                        ...
                        <form id="formObtComp" autocomplete="off" method="post" action="instanciasPertenecientes.php">
                                ...
                                <div class="col s12 l6 input-field">
                                      ...
                                      <input type="text"  required id="instancia" name="instancia" data-validetta="required,number,minLength[8],maxLength[10]">
                                </div>
					...
					?>
                                ...
                                <div class="col s12 l6 input-field">
                                      <i class="fa fa-user fa prefix"></i>
                                      <label for="instancia">Instancia:</label>
                                      <input type="text" value='<?=$n?>'  required id="instancia" name="instancia" data-validetta="required,number,minLength[8],maxLength[10]">
                                </div>
