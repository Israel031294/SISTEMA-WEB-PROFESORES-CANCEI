                ...
                <div class="row">
					...
					?>
                        ...
                        <form id="formObtComp" autocomplete="off" method="post" action="registroFormacionAcademica.php">
                                <div class="col s12 l6 input-field">
                                     ...
                                     <input type="text" id="nivel" name="nivel" data-validetta="required,number,minLength[8],maxLength[10]">
                                </div>
                                
                                <div class="col s12 l6 input-field">
                                      <i class="fa fa-scroll fa prefix"></i>
                                      <label for="nombrefaObt">Nombre:</label>
                                      <input type="text" id="nombrefa" name="nombrefa" data-validetta="required,number,minLength[8],maxLength[10]">
                                </div>
                                ...
                                <div class="col s12 l6 input-field">
                                  ...
                                  <div class="col s12 l6 input-field">
                                        ...
                                        <input type="text" id="pais" name="pais" data-validetta="required,number,minLength[8],maxLength[10]">
                                  </div>

                                  <div class="col s12 l6 input-field">
                                        <i class="fa fa-calendar-alt fa prefix"></i>
                                        <label for="anocObt">A&ntilde;o:</label>
                                        <input type="text" id="ano" name="ano" data-validetta="required,number,minLength[8],maxLength[10]">
                                  </div>

                                  <div class="col s12 l6 input-field">
                                        <i class="fa fa-address-card fa prefix"></i>
                                        <label for="cedulaObt">C&eacute;dula:</label>
                                        <input type="text" id="cedula" name="cedula" data-validetta="required,number,minLength[8],maxLength[10]">
                                  </div>
					...
					?>
                                ...
                                <div class="col s12 l6 input-field">
                                     <i class="fa fa-user-graduate fa prefix"></i>
                                     <label for="nivelObt">Nivel:</label>
                                     <input type="text" value=<?=$n?> id="nivel" name="nivel" data-validetta="required,number,minLength[8],maxLength[10]">
                                ...
                                <div class="col s12 l6 input-field">
                                      <i class="fa fa-scroll fa prefix"></i>
                                      <label for="nombrefaObt">Nombre:</label>
                                      <input type="text" value=<?=$l?> id="nombrefa" name="nombrefa" data-validetta="required,number,minLength[8],maxLength[10]">
                                </div>

                                <div class="col s12 l6 input-field">
                                        <i class="fa fa-building fa prefix"></i>
                                        <label for="institucionObt">Instituci&oacute;n:</label>
                                        <input type="text" value=<?=$o?> id="institucion" name="institucion" data-validetta="required,number,minLength[8],maxLength[10]">
                                  </div>

                                  <div class="col s12 l6 input-field">
                                        <i class="fa fa-flag-usa fa prefix"></i>
                                        <label for="paisObt">Pa&iacute;s:</label>
                                        <input type="text" value=<?=$h?> id="pais" name="pais" data-validetta="required,number,minLength[8],maxLength[10]">
                                  </div>

                                  <div class="col s12 l6 input-field">
                                        <i class="fa fa-calendar-alt fa prefix"></i>
                                        <label for="anocObt">A&ntilde;o:</label>
                                        <input type="text" value=<?=$z?> id="ano" name="ano" data-validetta="required,number,minLength[8],maxLength[10]">
                                  </div>

                                  <div class="col s12 l6 input-field">
                                        <i class="fa fa-address-card fa prefix"></i>
                                        <label for="cedulaObt">C&eacute;dula:</label>
                                        <input type="text" value=<?=$w?> id="cedula" name="cedula" data-validetta="required,number,minLength[8],maxLength[10]">
                                  </div>
