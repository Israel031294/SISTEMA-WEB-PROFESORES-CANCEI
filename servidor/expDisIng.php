        ...
        <section id="contenidos">
				...
				?>
                        <form id="formObtComp" autocomplete="off" method="post" action="expDisIng.php">
                                ...
                                <div class="col s12 l6 input-field">
                                        ...
                                        <input type="text" id="org" name="org" data-validetta="required">
                                  </div>

                                  <div class="col s12 l6 input-field">
                                        <i class="fa fa-globe-americas fa prefix"></i>
                                        <label for="lugarObt">Lugar:</label>
                                        <input type="text" id="lugar" name="lugar" data-validetta="required">
                                  </div>
                                  ...
                                  <div class="col s12 l6 input-field">
                                        ...
                                        <input type="text" id="periodo" name="periodo" data-validetta="required,number">
                                  </div>

                                  <div class="col s12 l6 input-field">
                                        <i class="fa fa-arrow-alt-circle-up fa prefix"></i>
                                        <label for="expObt">Nivel de experiencia:</label>
                                        <input type="text" id="exp" name="exp" data-validetta="required">
                                  </div>
           ...
           <form id="formObtComp" autocomplete="off" method="post" action="expDisIng.php">
                               ...
                               <div class="col s12 l6 input-field">
                                       <i class="fa fa-building fa prefix"></i>
                                       <label for="orgObt">Organismo:</label>
                                       <input type="text" value='<?=$n?>' id="org" name="org" data-validetta="required">
                                 </div>

                                 <div class="col s12 l6 input-field">
                                       <i class="fa fa-globe-americas fa prefix"></i>
                                       <label for="lugarObt">Lugar:</label>
                                       <input type="text" id="lugar" value='<?=$l?>' name="lugar" data-validetta="required">
                                 </div>
                                 ...
                                 <div class="col s12 l6 input-field">
                                       <i class="fa fa-calendar-alt fa prefix"></i>
                                       <label for="periodoObt">Periodo(a&ntilde;os):</label>
                                       <input type="text" id="periodo" value='<?=$o?>' name="periodo" data-validetta="required,number">
                                 </div>

                                 <div class="col s12 l6 input-field">
                                       <i class="fa fa-arrow-alt-circle-up fa prefix"></i>
                                       <label for="expObt">Nivel de experiencia:</label>
                                       <input type="text" id="exp" value='<?=$e?>' name="exp" data-validetta="required">
                                 </div>
