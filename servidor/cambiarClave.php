                ...
                <div class="row">
                        ...
                        <form id="formObtComp" autocomplete="off" method="post" action="cambiarClave.php">
                            ...
                            <div class="col s12 l12 input-field">
								...
								<input type="password"  required  id="actual" name="actual" data-validetta="required,number,minLength[8],maxLength[10]">
							</div>
							
							
							<div class="col s12 l12 input-field">
								<label for="clave">Clave nueva</label>
								<input type="password"  required  id="nueva" name="nueva" data-validetta="required,number,minLength[8],maxLength[10]">
							</div>
