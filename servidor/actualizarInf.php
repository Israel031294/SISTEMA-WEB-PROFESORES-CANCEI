                ...
                <div class="row">
                        ...
                        <form id="formObtComp" autocomplete="off" method="post" action="actualizarInf.php">
                                ...
                                <div class="col s12 l6 input-field">
                                      ...
                                      <input type="text" value='<?=$c?>'  required id="nombre" name="nombre" data-validetta="required,number,minLength[8],maxLength[10]">
                                </div>

                                <div class="col s12 l6 input-field">
                                        <i class="fa fa-user fa prefix"></i>
                                        <label for="primApObt">Primer Apellido:</label>
                                        <input type="text" value='<?=$d?>'  required id="primAp" name="primAp" data-validetta="required,number,minLength[8],maxLength[10]">
                                  </div>

                                  <div class="col s12 l6 input-field">
                                        <i class="fa fa-user fa prefix"></i>
                                        <label for="segApObt">Segundo Apellido:</label>
                                        <input type="text" value='<?=$e?>' required id="segAp" name="segApObt" data-validetta="required,number,minLength[8],maxLength[10]">
                                  </div>
                                  ...
                                  <div class="col s12 l6 input-field">
                                        ...
                                        <input type="text" value='<?=$b?>'  required id="puesto" name="puesto" data-validetta="required,number,minLength[8],maxLength[10]">
                                  </div>

                                  <div class="col s12 l6 input-field">
                                        <i class="fa fa-envelope fa prefix"></i>
                                        <label for="correoObt">Correo:</label>
                                        <input type="email" value='<?=$j?>'  required id="correo" name="correo" data-validetta="required,number,minLength[8],maxLength[10]">
                                  </div>

                                  <div class="col s12 l6 input-field">
                                        <i class="fa fa-phone fa prefix"></i>
                                        <label for="telObt">Tel/Cel:</label>
                                        <input type="number" value='<?=$k?>' required id="tel" name="tel" data-validetta="required,number,minLength[8],maxLength[10]">
                                  </div>
