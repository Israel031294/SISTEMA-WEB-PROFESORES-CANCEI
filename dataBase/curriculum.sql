...
create table premios(
	...
	idUsuario numeric(3) not null,
	nombre varchar(100) not null,
    organismo varchar(100)not null, #quién lo otorga
    anio numeric(4) not null,
    ...
    set existencia=(select count(*) from profesores where correo=mail); 
        ...
        case(existencia)
			...
			when 0 then
				...
				insert into Usuario values(identificador,mail,md5(pass),idTipoU);
...
call registraUsuario(2,'Jose','Molina','Garcia','jamgbatiz@gmail.com',044556079193,'12345678',7,'enero',1999,'Dios','2015090463');
